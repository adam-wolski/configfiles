...
let s:bg0 = " guibg=".s:white " Main background
let s:bgn = " guibg=".s:none
let s:bgl = " guibg=".s:graypp " Light back
let s:bgL = " guibg=".s:darkgraylighterpp " Even brighter light back
let s:bgd = " guibg=".s:graypp " Dark back
let s:bgD = " guibg=".s:whitepp " Even darker back
...
let s:fgb = " guifg=".s:white " Same color as bg0
let s:fge = " guifg=".s:red " Error fg
let s:fg0 = " guifg=".s:darkgraypp
let s:fg1 = " guifg=".s:darkgray 
let s:fg2 = " guifg=".s:graypp 
let s:fg3 = " guifg=".s:gray " Bit darker gray
let s:fgl = " guifg=".s:graypp " Light back
let s:fgL = " guifg=".s:gray " Even brighter light back
...
exe "hi! Comment"   .s:gi   .s:fa0   .s:bgn
"       *Comment         any comment
...
exe "hi! LineNr"   .s:gn   .s:fg0   .s:bgn
